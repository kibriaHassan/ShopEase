            ...
            <div className="flex flex-col md:flex-row gap-16 mt-4">
                    ...
                    <div className="flex flex-col gap-3">
                        {product.images.map((image, index) => (
                            <div 
                                ...
                                className={`border max-w-24 border-gray-500/30 rounded overflow-hidden cursor-pointer hover:border-indigo-500 transition`}
                            >
                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    <div className="mt-6">
                        ...
                        <p className="text-2xl font-medium">Offer Price: ${product.offerPrice}</p>
